...
#################################  ADD YOUR CODE HERE  ###############################
    ...
    # calib_data = numpy.load(calib_data_path)
    ...
    y2=ArUco_details_dict[5][0][1]
    x1=ArUco_details_dict[1][0][0]
    x2=ArUco_details_dict[2][0][0]
    warped_image=image[y2:y1,x1:x2]
...
#################################  ADD YOUR CODE HERE  ###############################
    ...
    wm=w/2
    hm=h/2
    c1=ArUco_details_dict[4][0][0]
    c1m=wm-c1
    c2=ArUco_details_dict[4][0][1]
    c2m=c2-hm
    a1=ArUco_details_dict[4][1]
    cop1=(c1m/wm)*0.9950
    cop2=(c2m/hm)*0.9950
    # cop1=0.9950-cop1
...
#################################  ADD YOUR CODE HERE  ###############################
    ...
    Angle.append(0)
    Angle.append(45)
    sim.setObjectPosition(aruco_handle,relativeToObjectHandle,scene_parameters)
